...
its source, confidence, and the FR-OG-7 alignment flag. The layer determines
the model used:
...
def route(
    ...
    """
    # L4: FR-OG-7 alignment — Sonnet only.
