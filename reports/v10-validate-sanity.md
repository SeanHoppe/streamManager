...
- candidate manifest: `v2.0.0-prod-equivalent`
- baseline  manifest: `v2.0.0-prod-equivalent`
- candidate L4 threshold: 0.750 | baseline L4 threshold: 0.750
- delta: 0.020
...
```json
{
  "baseline_l4_threshold": 0.75,
  "candidate_l4_threshold": 0.75,
  "fr_og_7_total": 10,
  "regressions": []
}
```
...
```json
{
  ...
  "cassette": "C:\\Users\\SeanHoppe\\VS\\streamManager\\.claude\\worktrees\\suspicious-mclaren-bb20cf\\tests\\fixtures\\soak_cassette_latest.jsonl",
